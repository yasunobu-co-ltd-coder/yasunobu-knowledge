...
--   - clients: matip-memo / pocket-matip の client_name を集約
--   - todos: pocket-matip の todos(jsonb) を個別行に展開
--   - decisions: pocket-matip の decisions(jsonb) を個別行に展開
-- Created: 2026-03-18
...
FROM (
  SELECT client_name FROM "matip-memo"
  WHERE client_name IS NOT NULL AND client_name != ''
  UNION
  SELECT client_name FROM "pocket-matip"
  WHERE client_name IS NOT NULL AND client_name != ''
) AS all_clients
...
-- =============================================================================
-- 2. todos 初期投入
--    pocket-matip の todos(jsonb配列) を1行ずつ展開
-- =============================================================================
...
-- =============================================================================
-- 3. decisions 初期投入
--    pocket-matip の decisions(jsonb配列) を1行ずつ展開
-- =============================================================================
